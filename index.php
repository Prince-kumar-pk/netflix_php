...
{
    header("location: netflixhome.php");
    exit;
}
...
<body>
    <header>
        <nav class="navbar">
            ...
            <div class="navbar__nav__items">
                ...
                <div class="nav__item">
                    <button class="signin__button" id="openPopup">Sign Up</button>
                </div>
            </div>
        </nav>
    </header>
    ...
    <main>
        ...
        <section class="hero">
            ...
            <div class="hero__card">
                ...
                <p class="hero__subtitle">Join today. Cancel anytime.</p>
                <p class="hero__description">
                    Ready to watch? Enter your email to create or restart your membership.
                </p>

                <form class="email__form__container" action="" method="POST">

                    <div class="form__container">
                        <input type="text" class="email__input" name="username" placeholder=" " />
                        <label class="email__label">User Name</label>
                    </div>

                    <div class="form__container">
                        <input type="password" class="email__input" name="password" placeholder=" " />
                        <label class="email__label">PassWord</label>
                    </div>
    ...
    <footer>
        ...
        <div class="footer__row__4">
            <p>Netflix India~Prince Kumar</p>
        </div>
    </footer>
